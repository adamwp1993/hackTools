<?php
# Check out "hospital" machine walkthrough by ippsec on youtube - section on dfunc bypass 
# you can either use dfunc.py and input the phpinfo() output, or if you can execute php code on the server you can drop this payload to retrieve that information
# then we can use that output to get around the disabled_functions and pop a shell. 
